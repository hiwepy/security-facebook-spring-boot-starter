...
public class FacebookAccessTokenExpiredException extends AuthenticationTokenExpiredException {
	...
	/**
	 * Constructs an <code>FacebookAccessTokenExpiredException</code> with the
	 * specified message.
	 *
	 * @param msg the detail message
	 */
	public FacebookAccessTokenExpiredException(String msg) {
		super(msg);
	}
	 ...
	 * @param t root cause
	 */
	public FacebookAccessTokenExpiredException(String msg, Throwable t) {
		super(msg, t);
	}
