...
public class FacebookAccessTokenIncorrectException extends AuthenticationTokenIncorrectException {
	...
	/**
	 * Constructs an <code>FacebookAccessTokenIncorrectException</code> with the
	 * specified message.
	 *
	 * @param msg the detail message
	 */
	public FacebookAccessTokenIncorrectException(String msg) {
		super(msg);
	}
	 ...
	 * @param t root cause
	 */
	public FacebookAccessTokenIncorrectException(String msg, Throwable t) {
		super(msg, t);
	}
